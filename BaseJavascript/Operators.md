...
Operadores de atribuição composto Nome 	Operador encurtado 	Significado
Atribuição 	x = y 	x = y
...
Operadores de comparação Operador 	Descrição 	Exemplos que retornam verdadeiro
...
Operadores bit a bit Operador 	Expressão 	Descrição
...
Exemplo de operação bit a bit Expressão 	Resultado 	Descrição binária
...
Operadores bit a bit de deslocamento Operador 	Descrição 	Exemplo
...
Operadores lógico Operador 	Utilização 	Descrição
...
Precedência de operadores Tipo de operador 	Operadores individuais
membro 	. []
